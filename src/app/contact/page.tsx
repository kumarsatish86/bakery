              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      Orders: (555) 123-4568<br />
                      Customer Service: (555) 123-4569
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      General: info@sweetbakery.com<br />
                      Orders: orders@sweetbakery.com<br />
                      Support: support@sweetbakery.com
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="h-96 bg-gray-200 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">123 Bakery Street, Sweetville, SV 12345</p>
              </div>
            </div>
          </div>
        </div>
